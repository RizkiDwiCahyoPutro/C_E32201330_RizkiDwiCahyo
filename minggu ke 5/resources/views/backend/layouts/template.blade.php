        ...
        <div class="top-nav notification-row">
          ...
          <ul class="nav pull-right top-menu">
            ...
            <li id="task_notificatoin_bar" class="dropdown">
              <a data-toggle="dropdown" class="dropdown-toggle" href="/backend/#">
              ...
              <ul class="dropdown-menu extended tasks-bar">
                ...
                <li class="external">
                  <a href="/backend/#">See All Tasks</a>
                </li>
              </ul>
            </li>
            ...
            <li id="mail_notificatoin_bar" class="dropdown">
              ...
              <ul class="dropdown-menu extended inbox">
                ...
                <li>
                  <a href="/backend/#">See all messages</a>
                </li>
              </ul>
            </li>
            ...
            <li id="alert_notificatoin_bar" class="dropdown">
              ...
              <ul class="dropdown-menu extended notification">
                ...
                <li>
                  <a href="/backend/#">See all notifications</a>
                </li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu extended logout">
                ...
                <li class="eborder-top">
                  <a href="/backend/#"><i class="icon_profile"></i> My Profile</a>
                </li>
                <li>
                  <a href="/backend/#"><i class="icon_mail_alt"></i> My Inbox</a>
                </li>
                <li>
                  <a href="/backend/#"><i class="icon_clock_alt"></i> Timeline</a>
                </li>
                <li>
                  <a href="/backend/#"><i class="icon_chat_alt"></i> Chats</a>
                </li>
                <li>
                  <a href="/backend/login.php"><i class="icon_key_alt"></i> Log Out</a>
                </li>
                <li>
                  <a href="/backend/documentation.php"><i class="icon_key_alt"></i> Documentation</a>
                </li>
                <li>
                  <a href="/backend/documentation.php"><i class="icon_key_alt"></i> Documentation</a>
                </li>
